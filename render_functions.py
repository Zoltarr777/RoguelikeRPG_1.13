...
from menus import character_screen, inventory_menu, level_up_menu, bag_menu, help_menu, equipment_inventory_menu, quit_menu, drop_menu, sell_menu, buy_menu, shop_menu
